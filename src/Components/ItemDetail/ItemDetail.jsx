...
const ItemDetail = ({ product }) => { 
    ...
    return (
      ...
      <center className="col m-5" >   <div className="bg-dark bg-opacity-50 border border-danger border-5 rounded-1" style={{width:"45vw"}}> 
            ...
            <div >
                ...
                />
                    ...
                    <>
                       <Link to='/cart'>
                            <button className="btn btn-outline-light mt-2 me-3">Ir a Cart</button>
                        </Link>
                        <Link to='/'>
                            <button className="btn btn-outline-light mt-2">Seguir Comprando</button>
                        </Link>
                    </>
            </div>
                </div>
